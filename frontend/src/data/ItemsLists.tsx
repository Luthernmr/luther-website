...
export const professionalExperiences = [
  ...
  "Mise en place des bonnes pratiques et réorganisation des répertoires Git et de sécurité sur des projets de la BU data.",
  "Conteneurisation de divers projets JAVA, React, Golang à l'aide de Docker"
]
